...
<body>
	<div class="err-box">
		...
		<div class="err-title">${pageContext.errorData.statusCode == 404 ? 'Page Not Found' : 'Something Went Wrong'}
		</div>
		<p class="err-desc">${pageContext.errorData.statusCode == 404
              ? 'The page you are looking for does not exist or has been moved.'
              : 'An unexpected error occurred. Please try again or contact support.'}
		</p>
		<a href="${pageContext.request.contextPath}/dashboard"
			class="btn-home"> <i class="fas fa-house"></i> Go to Dashboard
		</a>
	</div>
</body>
</html>
