...
public class translate extends FunctionCalls {
   ...
   public void toMSSQLServer(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      this.functionName.setColumnName("DBO.TRANSLATE");
      Vector arguments = new Vector();
      ...
      this.setFunctionArguments(arguments);
      this.setAdventNetMessageString("SwisSQL Message : TRANSLATE() Function is not supported in SQLServer");
   }
   ...
   public void toSybase(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      this.setFunctionArguments(arguments);
      throw new ConvertException("TRANSLATE() is not supported in SQLServer");
   }
   ...
   public void toDB2(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      this.setFunctionArguments(arguments);
      Object obj = this.functionArguments.elementAt(1);
      this.functionArguments.setElementAt(this.functionArguments.elementAt(2), 1);
      this.functionArguments.setElementAt(obj, 2);
   }
   ...
   public void toTeradata(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      this.functionName.setColumnName("OTRANSLATE");
      Vector arguments = new Vector();
