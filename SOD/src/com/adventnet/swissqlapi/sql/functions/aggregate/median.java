...
public class median extends FunctionCalls {
   public void toMySQL(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      SelectColumn medianSC = new SelectColumn();
      Vector vc_medianOut = new Vector();
      FunctionCalls fnCl_median = new FunctionCalls();
      TableColumn tbCl_median = new TableColumn();
      tbCl_median.setColumnName(this.functionName.getColumnName());
      fnCl_median.setFunctionName(tbCl_median);
      ...
      fnCl_median.setFunctionArguments(arguments);
      vc_medianOut.addElement(fnCl_median);
      medianSC.setColumnExpression(vc_medianOut);
      SelectColumn finalSC = new SelectColumn();
      Vector finalVCIn = new Vector();
      Vector finalVCOut = new Vector();
      finalVCIn.addElement(medianSC);
      finalVCIn.add("*");
      finalVCIn.add("1");
   ...
   public void toMSSQLServer(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      qry = "PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY " + arguments.get(0).toString() + ") OVER()";
      this.functionName.setColumnName(qry);
      this.setOpenBracesForFunctionNameRequired(false);
      this.functionArguments = new Vector();
   }
   ...
   public void toBigQuery(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      qry = "PERCENTILE_CONT(" + arguments.get(0).toString() + ", 0.5 ) OVER()";
      this.functionName.setColumnName(qry);
      this.setOpenBracesForFunctionNameRequired(false);
      this.functionArguments = new Vector();
   }
   ...
   public void toAthena(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      String qry = "APPROX_PERCENTILE(" + arguments.get(0).toString() + ",0.5)";
      this.functionName.setColumnName(qry);
      this.setOpenBracesForFunctionNameRequired(false);
      this.functionArguments = new Vector();
   }
