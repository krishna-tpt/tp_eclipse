...
public class stddeviation extends FunctionCalls {
   public void toOracle(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      this.functionName.setColumnName("STDDEV");
   ...
   public void toSnowflake(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      if (this.functionName.getColumnName().equalsIgnoreCase("STDDEV_SAMP")) {
         this.functionName.setColumnName("STDDEV_SAMP");
      } else {
         this.functionName.setColumnName("STDDEV");
      }
   ...
   public void toMSSQLServer(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      if (this.functionName.getColumnName().equalsIgnoreCase("STDDEV_SAMP")) {
         this.functionName.setColumnName("STDEV");
      } else {
         this.functionName.setColumnName("STDEVP");
      }
   ...
   public void toPostgreSQL(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      if (this.functionName.getColumnName().equalsIgnoreCase("STDDEV_SAMP")) {
         ...
         this.functionName.setColumnName("STDDEV_POP");
      }
   ...
   public void toMySQL(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      if (!this.functionName.getColumnName().equalsIgnoreCase("STDDEV_SAMP") && !this.functionName.getColumnName().equalsIgnoreCase("STDDEV_SAMPLE")) {
         if (from_sqs != null && from_sqs.isHyperSql()) {
            this.functionName.setColumnName("STDDEV_POP");
         } else {
            this.functionName.setColumnName("STD");
         }
      } else {
         this.functionName.setColumnName("STDDEV_SAMP");
      }
   ...
   public void toInformix(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      String qry;
      if (this.functionName.getColumnName().equalsIgnoreCase("STDDEV_SAMP")) {
         String whereExp = from_sqs.getWhereExpression() != null ? " WHERE " + from_sqs.getWhereExpression() : "";
         qry = "SQRT((SUM((" + arguments.get(0) + " - (SELECT AVG(" + arguments.get(0) + ") " + from_sqs.getFromClause() + whereExp + "))*(" + arguments.get(0) + " - (SELECT AVG(" + arguments.get(0) + ") " + from_sqs.getFromClause() + whereExp + "))) / (COUNT(" + arguments.get(0) + ")-1)))";
      } else {
         qry = "STDEV(" + arguments.get(0) + ")";
      }
   ...
   public void toNetezza(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      if (this.functionName.getColumnName().equalsIgnoreCase("STDEV") || this.functionName.getColumnName().equalsIgnoreCase("STD")) {
         this.functionName.setColumnName("STDDEV");
      }
   ...
   public void toSapHana(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      if (this.functionName.getColumnName().equalsIgnoreCase("STDDEV_SAMP")) {
         this.functionName.setColumnName("STDDEV_SAMP");
      } else if (this.functionName.getColumnName().equalsIgnoreCase("STDDEV_POP")) {
         this.functionName.setColumnName("STDDEV_POP");
      } else {
         this.functionName.setColumnName("STDDEV");
      }
   ...
   public void toSqlite(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      if (this.functionName.getColumnName().equalsIgnoreCase("STDDEV_SAMP")) {
         ...
         qry = "sqrt(avg(" + arguments.get(0) + "*" + arguments.get(0) + ")-avg(" + arguments.get(0) + ")*avg(" + arguments.get(0) + "))";
      }
   ...
   public void toExcel(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      Vector arguments = new Vector();
      if (this.functionName.getColumnName().equalsIgnoreCase("STDDEV_POP")) {
         this.functionName.setColumnName("StDevP");
      } else {
         this.functionName.setColumnName("StDev");
      }
