...
public class subduration extends FunctionCalls {
   public void toMySQL(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      vc_floor.addElement("-");
      Object inArg1 = ((SelectColumn)arguments.get(1)).getColumnExpression().get(0);
      if (inArg1 instanceof String) {
         vc_floor.addElement(getNumericalDurationValue(inArg1));
      } else {
         vc_floor.addElement(arguments.get(1));
      }
