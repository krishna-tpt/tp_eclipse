...
public class space extends FunctionCalls {
   ...
   public void toMSSQLServer(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      this.functionName.setColumnName("SPACE");
      Vector arguments = new Vector();
   ...
   public void toPostgreSQL(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      this.functionName.setColumnName("repeat(' '::" + dataType + "," + arguments.get(0).toString() + ")");
      Integer number = StringFunctions.getIntegerValue(arguments.get(0).toString());
      if (number != null) {
         this.functionName.setColumnName("repeat(' '::" + dataType + "," + number + ")");
      } else if (from_sqs != null && from_sqs.getBooleanValues("use.udf.functions.for.text") && !isPostgreLiveDbs) {
         this.functionName.setColumnName("REPEAT(' '::text, TOINTEGER_UDF(" + arguments.get(0).toString() + "))");
      }
   ...
   public void toBigQuery(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      Integer number = StringFunctions.getIntegerValue(arguments.get(0).toString());
      if (number != null) {
         this.functionName.setColumnName("REPEAT(CAST(' ' AS STRING)," + number + ")");
      }
   ...
   public void toAthena(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      Integer number = StringFunctions.getIntegerValue(arguments.get(0).toString());
      if (number != null) {
         this.functionName.setColumnName("ARRAY_JOIN(REPEAT(CAST(' ' AS VARCHAR)," + number + "),'')");
      }
   ...
   public void toSqlite(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      Integer number = StringFunctions.getIntegerValue(arguments.get(0).toString());
      if (number != null) {
         this.functionName.setColumnName("REPLACE(HEX(ZEROBLOB(" + number + ")), '00',' ')");
      }
