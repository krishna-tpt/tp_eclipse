...
public class ltrim extends FunctionCalls {
   ...
   public void toTeradata(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      if (i_count > 1) {
         ...
         this.setArgumentQualifier("LEADING");
   ...
   public void toTimesTen(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      if (this.functionName.getColumnName().equalsIgnoreCase("LTRIM")) {
         throw new ConvertException("\nThe function LTRIM is not supported in TimesTen 5.1.21\n");
      }
   }
