...
public class length extends FunctionCalls {
   public void toOracle(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      if (this.functionName.getColumnName().equalsIgnoreCase("LEN")) {
         this.functionName.setColumnName(isdenodo ? "LEN(RTRIM" : "LENGTH(RTRIM");
         isLENCalled = true;
      } else {
         this.functionName.setColumnName(isdenodo ? "LEN" : "LENGTH");
      }
   ...
   public void toMSSQLServer(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      if (this.functionName.getColumnName().equals("LEN")) {
         arguments.set(0, "REPLACE(" + arguments.get(0).toString() + ",' ',CHAR(160))");
      }
   ...
   public void toSnowflake(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      if (!this.functionName.getColumnName().equalsIgnoreCase("octet_length")) {
         this.functionName.setColumnName("LENGTH");
      }
   ...
   public void toExcel(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      if (this.functionName.getColumnName().equalsIgnoreCase("octet_length")) {
         this.functionName.setColumnName("LENB");
      } else {
         this.functionName.setColumnName("LEN");
      }
