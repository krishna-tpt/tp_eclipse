...
public class radians extends FunctionCalls {
   public void toOracle(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      StringBuffer radians = new StringBuffer();
      if (this.functionArguments.elementAt(0) instanceof SelectColumn) {
         radians.append(((SelectColumn)this.functionArguments.elementAt(0)).toOracleSelect(to_sqs, from_sqs).toString());
      } else {
         radians.append(this.functionArguments.elementAt(0).toString());
      }

      this.functionName.setColumnName("(" + radians + ")" + " * (3.14159265358979/180)");
      this.setOpenBracesForFunctionNameRequired(false);
      this.functionArguments = new Vector();
   }

   public void toMSSQLServer(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      this.functionName.setColumnName("RADIANS");
   ...
   public void toTimesTen(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      StringBuffer radians = new StringBuffer();
      if (this.functionArguments.elementAt(0) instanceof SelectColumn) {
         radians.append(((SelectColumn)this.functionArguments.elementAt(0)).toTimesTenSelect(to_sqs, from_sqs).toString());
      } else {
         radians.append(this.functionArguments.elementAt(0).toString());
      }
   ...
   public void toVectorWise(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      StringBuffer radians = new StringBuffer();
      if (this.functionArguments.elementAt(0) instanceof SelectColumn) {
         radians.append(((SelectColumn)this.functionArguments.elementAt(0)).toVectorWiseSelect(to_sqs, from_sqs).toString());
      } else {
         radians.append(this.functionArguments.elementAt(0).toString());
      }
   ...
   public void toBigQuery(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      String qry = "((ACOS(-1)/180) * " + arguments.get(0).toString() + ")";
   ...
   public void toExcel(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      StringBuffer radians = new StringBuffer();
      if (this.functionArguments.elementAt(0) instanceof SelectColumn) {
         radians.append(((SelectColumn)this.functionArguments.elementAt(0)).toExcelSelect(to_sqs, from_sqs).toString());
      } else {
         radians.append(this.functionArguments.elementAt(0).toString());
      }
