...
public class degrees extends FunctionCalls {
   public void toOracle(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      if (this.functionArguments.elementAt(0) instanceof SelectColumn) {
         degrees.append(((SelectColumn)this.functionArguments.elementAt(0)).toOracleSelect(to_sqs, from_sqs).toString());
      } else {
         degrees.append(this.functionArguments.elementAt(0).toString());
      }

      this.functionName.setColumnName("(" + degrees + ")" + " * (180/3.14159265358979)");
   ...
   public void toTimesTen(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      StringBuffer degrees = new StringBuffer();
      if (this.functionArguments.elementAt(0) instanceof SelectColumn) {
         degrees.append(((SelectColumn)this.functionArguments.elementAt(0)).toTimesTenSelect(to_sqs, from_sqs).toString());
      } else {
         degrees.append(this.functionArguments.elementAt(0).toString());
      }
   ...
   public void toBigQuery(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      String qry = "((180/ACOS(-1)) * " + arguments.get(0).toString() + ")";
   ...
   public void toExcel(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      StringBuffer degrees = new StringBuffer();
      if (this.functionArguments.elementAt(0) instanceof SelectColumn) {
         degrees.append(((SelectColumn)this.functionArguments.elementAt(0)).toExcelSelect(to_sqs, from_sqs).toString());
      } else {
         degrees.append(this.functionArguments.elementAt(0).toString());
      }
