...
public class cot extends FunctionCalls {
   public void toOracle(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      FunctionCalls tan = new FunctionCalls();
   ...
   public void toMySQL(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      Vector finalArgs = new Vector(1);
      SelectColumn sc_nullif = new SelectColumn();
      Vector vc_nullif = new Vector(1);
      FunctionCalls funCl_nullif = new FunctionCalls();
      TableColumn tbCl_nullif = new TableColumn();
      tbCl_nullif.setColumnName("NULLIF");
      funCl_nullif.setFunctionName(tbCl_nullif);
      Vector vc_funCl_nullif = new Vector(2);
      vc_funCl_nullif.add(arguments.get(0));
      vc_funCl_nullif.add("0");
      funCl_nullif.setFunctionArguments(vc_funCl_nullif);
      vc_nullif.add(funCl_nullif);
      sc_nullif.setColumnExpression(vc_nullif);
      finalArgs.add(sc_nullif);
   ...
   public void toTimesTen(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      for(int i_count = 0; i_count < this.functionArguments.size(); ++i_count) {
         ...
         arguments.add(1.0D / Math.tan(Double.parseDouble(colExpr.get(0).toString())) + "");
         this.functionName.setColumnName("");
         this.setFunctionArguments(arguments);
   ...
   public void toVectorWise(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      String qry = "(1/TAN(NULLIF(" + arguments.get(0).toString() + ",0)))";
   ...
   public void toBigQuery(SelectQueryStatement to_sqs, SelectQueryStatement from_sqs) throws ConvertException {
      ...
      String qry = "(1/TAN(" + arguments.get(0).toString() + "))";
      this.functionName.setColumnName(qry);
      this.setFunctionArguments(new Vector());
      this.setOpenBracesForFunctionNameRequired(false);
   }
