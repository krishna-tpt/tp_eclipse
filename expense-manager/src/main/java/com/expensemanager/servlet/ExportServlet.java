...
/**
 * GET /export?type=pdf          → download PDF
 * GET /export?type=excel        → download Excel
...
public class ExportServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            resp.sendRedirect(req.getContextPath() + "/home?exportError=" +
    ...
    private String buildEmailBody(CashBook book, int count,
        ...
        return "<html><body style='font-family:Inter,sans-serif;color:#1e293b'>"
             ...
             + "<td style='padding:.4rem 1rem'>&#8377;" + income.subtract(expense) + "</td></tr>"
             + "</table>"
             + "<p style='color:#64748b;font-size:.85rem'>"
             + count + " transactions &nbsp;|&nbsp; Generated by ExpenseOS</p>"
             + "</body></html>";
    }
}
