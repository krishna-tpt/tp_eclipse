    ...
    <div class="stat-value balance">
      <c:choose>
        <c:when test="${totalIncome > 0}">
          <fmt:formatNumber value="${(balance/totalIncome)*100}" pattern="#0.0"/>%
        </c:when>
...
<div class="chart-card mb-2">
  <div class="chart-title">Monthly Income vs Expense (Last 6 Months)</div>
...
<div class="charts-grid">
  ...
  <div class="chart-card">
    ...
    <div class="chart-wrap"><canvas id="incCatChart"></canvas></div>
  </div>
</div>
