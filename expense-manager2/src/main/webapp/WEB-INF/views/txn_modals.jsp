...
if (request.getAttribute("incomeCategories") == null) {
	try {
	com.expense.daoo.CategoryDAO cDao = newcom.expense.daoo.CategoryDAO();
	com.expense.daoo.ColumnDefinitionDAO colDao = newcom.expense.daoo.ColumnDefinitionDAO();
	com.expense.daoo.SubCategoryDAO scDao = newcom.expense.daoo.SubCategoryDAO();
