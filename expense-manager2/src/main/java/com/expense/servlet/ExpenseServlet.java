...
public class ExpenseServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        if (path == null || path.equals("/") || path.equals("/list")) {
            listTransactions(req, res); return;
        }
        switch (path) {
            case "/add":
                showForm(req, res, null); break;
            case "/edit":
                try {
                    Transaction t = dao.getById(TYPE, Integer.parseInt(req.getParameter("id")));
                    showForm(req, res, t);
                } catch (Exception e) {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            if ("addColumn".equals(action)) {
                ...
                res.sendRedirect(req.getContextPath() + "/expense/list"); return;
            }
            ...
            if ("addCategory".equals(action)) {
                ...
                res.sendRedirect(req.getContextPath() + "/expense/add"); return;
            }
