...
public class Transaction {
	...
	public Transaction(int id, Date date, Time time, BigDecimal amount, String category, String note, String type) {
		this.id = id;
	...
	public void setCustomValues(Map<String, String> m) {
		this.customValues = m;
	}
